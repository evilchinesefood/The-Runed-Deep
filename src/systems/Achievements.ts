...
export const ACHIEVEMENTS: Achievement[] = [
  // Combat
  { id: 'first-blood', name: 'First Blood', description: 'Kill your first monster', icon: '⚔' },
  { id: 'monster-slayer', name: 'Monster Slayer', description: 'Kill 100 monsters', icon: '💀' },
  { id: 'giant-killer', name: 'Giant Killer', description: 'Defeat a boss monster', icon: '👑' },
  { id: 'surturs-bane', name: "Surtur's Bane", description: 'Defeat Surtur and beat the game', icon: '🔥' },
  { id: 'untouchable', name: 'Untouchable', description: 'Clear a floor without taking damage', icon: '✨' },
  // Progression
  { id: 'into-the-depths', name: 'Into the Depths', description: 'Reach floor 10', icon: '⬇' },
  { id: 'fortress-breaker', name: 'Fortress Breaker', description: 'Enter the Underground Fortress', icon: '🏰' },
  { id: 'castle-stormer', name: 'Castle Stormer', description: 'Enter the Castle of the Winds', icon: '⚡' },
  { id: 'new-beginnings', name: 'New Beginnings', description: 'Complete New Game Plus', icon: '🔄' },
  { id: 'maximum-power', name: 'Maximum Power', description: 'Reach level 30', icon: '⭐' },
  // Items & Equipment
  { id: 'well-equipped', name: 'Well Equipped', description: 'Fill every equipment slot', icon: '🛡' },
  { id: 'treasure-hunter', name: 'Treasure Hunter', description: 'Pick up 50 items', icon: '💎' },
  { id: 'legendary-find', name: 'Legendary Find', description: 'Find an item with 4+ enchantments', icon: '✦' },
  { id: 'elven-heritage', name: 'Elven Heritage', description: 'Equip 3+ elven items', icon: '🌿' },
  { id: 'meteoric-arsenal', name: 'Meteoric Arsenal', description: 'Equip 3+ meteoric items', icon: '☄' },
  // Exploration & Skills
  { id: 'cartographer', name: 'Cartographer', description: 'Fully explore a dungeon floor', icon: '🗺' },
  { id: 'secret-keeper', name: 'Secret Keeper', description: 'Find 5 secret doors', icon: '🚪' },
  { id: 'shopaholic', name: 'Shopaholic', description: 'Spend 5,000 gold at shops', icon: '💰' },
];
...
const STORAGE_KEY = 'cotw-achievements';
...
export function loadAchievements(): AchievementState {
  ...
  return {
    unlocked: [],
    stats: { monstersKilled: 0, itemsPickedUp: 0, secretDoorsFound: 0, goldSpentAtShops: 0, floorDamageTaken: {} },
  };
}
...
export function setOnUnlockCallback(cb: (achievement: Achievement) => void): void {
  onUnlockCallback = cb;
}
...
export function trackItemFound(specialEnchantments?: string[]): void {
  if (specialEnchantments && specialEnchantments.length >= 4) unlock('legendary-find');
}

export function trackEquipmentCheck(equipment: Record<string, unknown>): void {
  const mainSlots = ['weapon', 'shield', 'helmet', 'body', 'cloak', 'bracers', 'gauntlets', 'belt', 'boots', 'ringLeft', 'amulet'];
...
export function trackFloorCleared(floorKey: string, monstersRemaining: number): void {
...
export function trackFloorExplored(explored: boolean[][], width: number, height: number, tiles: { walkable: boolean }[][]): void {
